...
<div class="container_zakatFitrah">
    ...
    <div class="container_isi">
        ...
        <div class="header flex">
            <h1 class="title">Distribusi Zakat Fitrah Lainnya</h1>
            <div class="container_item flex">
                <button type="submit" class="item search" for="form_search">
                    <form action="{{ url('/zakatFitrah/distribusiLainnya') }}" method="GET">
                        @csrf
                            ...
                            <div class="modal-body">
                                <div class="header flex">
                                    ...
                                    <div class="flex"> 
                                        ...
                                        <a href="{{ url('/zakatFitrah/distribusiLainnya/destroyAll') }}" class="btn btn-third item_inner">Hapus Semua</a>
                                        @endif
                                    </div>
                                </div>
                ...
                <div class="modal fade modal_nohide1" id="modal_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('/zakatFitrah/distribusiLainnya') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="kategori" type="text" class="form-select" id="kumpulZakat_text" required> 
                                                <option value="" disabled selected>-- select --</option>
                                                @foreach($datas2_lainnya as $key2=>$value2)
                        ...
                        <div class="modal fade" id="editModal{{$value->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ url('/zakatFitrah/distribusiLainnya/'.$value->id) }}" method="POST">
                                        @csrf
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row align-items-start">   
                                            <div class="col"> 
                                                <form method="POST" action="{{ url('/zakatFitrah/distribusiLainnya/addTerima/'.$value->id) }}">
                                                @csrf
                                                    <div class="mb-3">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form method="POST" action="{{ url('/zakatFitrah/distribusiLainnya/'.$value->id) }}">
                                        @csrf
                                        <input type="hidden" name="_method" value="DELETE">
